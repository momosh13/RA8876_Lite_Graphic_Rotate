...
#define SCAN_FREQ	40  // Panel Scan clock frequency, unit: MHz.
...
memory size. For example : page_size = 800*600*2byte(16bpp) = 960000byte, maximum number = 32/0.96 = 33.3 */
...
#define PATTERN1_RAM_START_ADDR 800*600*2*10
#define PATTERN2_RAM_START_ADDR (800*600*2*10)+(16*16*2)
#define PATTERN3_RAM_START_ADDR (800*600*2*10)+(16*16*2)+(16*16*2)

/*DMA picture data start address*/
#define WP1_ADDR  0
#define WP2_ADDR  800*600*2
#define WP3_ADDR  800*600*2*2
#define WP4_ADDR  800*600*2*3
#define WP5_ADDR  800*600*2*4
#define WP6_ADDR  800*600*2*5
...
class Ra8876_Lite
{
 ...
 int _xnscs, _xnreset;
 public:
 Ra8876_Lite(int xnscs, int xnreset);
 boolean begin(void);
...
/*DMA function*/
 ...
 void activeWindowXY_Rotate(ru16 x0,ru16 y0);
 void activeWindowWH_Rotate(ru16 width,ru16 height);
 void setPixelCursor_Rotate(ru16 x,ru16 y);
 void putPixel_16bpp_Rotate(ru16 x,ru16 y,ru16 color);
 void putPicture_16bpp_Rotate(ru16 x,ru16 y,ru16 width, ru16 height);
 void putPicture_16bpp_Rotate(ru16 x,ru16 y,ru16 width, ru16 height, const unsigned char *data);
 void putPicture_16bpp_Rotate(ru16 x,ru16 y,ru16 width, ru16 height, const unsigned short *data);
 void drawLine_Rotate(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);
 void drawSquare_Rotate(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);
 void drawSquareFill_Rotate(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);
 
 void drawCircleSquare_Rotate(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 xr, ru16 yr, ru16 color);
 void drawCircleSquareFill_Rotate(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 xr, ru16 yr, ru16 color);
 void drawTriangle_Rotate(ru16 x0,ru16 y0,ru16 x1,ru16 y1,ru16 x2,ru16 y2,ru16 color);
 void drawTriangleFill_Rotate(ru16 x0,ru16 y0,ru16 x1,ru16 y1,ru16 x2,ru16 y2,ru16 color);
 void drawCircle_Rotate(ru16 x0,ru16 y0,ru16 r,ru16 color);
 void drawCircleFill_Rotate(ru16 x0,ru16 y0,ru16 r,ru16 color);
 void drawEllipse_Rotate(ru16 x0,ru16 y0,ru16 xr,ru16 yr,ru16 color);
 void drawEllipseFill_Rotate(ru16 x0,ru16 y0,ru16 xr,ru16 yr,ru16 color);
 
 
 void setTextParameter2_Rotate(ru8 align, ru8 chroma_key, ru8 width_enlarge, ru8 height_enlarge);	
 void setTextCursor_Rotate(ru16 x,ru16 y);	
 void putString_Rotate(ru16 x0,ru16 y0, char *str);
 void putDec_Rotate(ru16 x0,ru16 y0,rs32 vaule,ru8 len,const char *flag);
 void putFloat_Rotate(ru16 x0,ru16 y0,double vaule,ru8 len,ru8 precision, const char *flag);
 void putHex_Rotate(ru16 x0,ru16 y0,ru32 vaule,ru8 len,const char *flag); 
};
